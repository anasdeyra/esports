  ...
  return (
    ...
    >
      <div className="w-fit">
        ...
        <button className="mx-auto md:mx-0 md:ml-auto block mt-14  hover:-translate-y-1 active:translate-y-0 active:brightness-[0.85] hero-btn-alt px-10 py-5 text-xl font-bold">
          EXPLORE
        </button>
      </div>
    </div>

...
export default function Vision() {
  return (
    <div className="pt-28 max-w-[1440px] mx-auto relative">
      <motion.h2
      ...
      <div className="flex  mt-32 items-center gap-x-6">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 494 7" fill="none">
          <path
        ...
        <motion.h3
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="font-bold shrink-0 text-5xl md:text-6xl text-center"
        >
          Our Product
        </motion.h3>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 494 7" fill="none">
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="p-28 max-md:px-8 w-full text-center mt-12"
      ...
      >
        <path
          d="M77.4031 0H0V219H1440V128.207H160.838L113.089 102.765L77.4031 0Z"
          fill="#1A244F"
          fillOpacity="0.5"
        />
      </svg>
